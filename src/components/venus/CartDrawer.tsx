...
export function CartDrawer({
  ...
  // Génération du message WhatsApp pré-rempli pour la commande directe
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-black/70 backdrop-blur-sm transition-opacity">
      <div className="relative flex h-full w-full max-w-md flex-col bg-[#090D16] p-6 text-foreground shadow-2xl border-l border-border/60">
        
        {/* En-tête Panier */}
        <div className="flex items-center justify-between border-b border-border/60 pb-4">
          <div className="flex items-center gap-3">
            <span className="font-serif text-xl text-gold">Votre Sélection</span>
            <span className="rounded-full bg-gold/20 px-2.5 py-0.5 text-xs text-gold">
